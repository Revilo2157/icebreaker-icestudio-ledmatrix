  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "7536e7c4-d9ce-4e4a-8a1c-ed83be992df9",
          "type": "basic.constant",
          "data": {
            "name": "lsb_duration",
            "value": "48",
        ...
        {
          "id": "d4c65774-b86d-4d18-8252-0572909f0552",
          "type": "basic.memory",
          "data": {
            "name": "mem_file",
            "list": "02c02783\n800006b7\n00ff0637\n00178793\n02f02623\n0006a703\n00c7f7b3\n00371713\n00f767b3\n00f6a023\n0000006f",
        ...
        {
          "id": "ef99ec8d-f6ba-455b-baf2-b11c9e8aa460",
          "type": "basic.code",
          "data": {
            "code": "assign o = i[23:0];",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "98f3f157-c1ca-4536-959f-68984033cef7",
          "type": "basic.code",
          "data": {
            "code": "// @include picorv32.v\n\npicorv32 #(\n    .ENABLE_COUNTERS(0),\n    .ENABLE_COUNTERS64(0),\n    .ENABLE_REGS_16_31(0),\n    .ENABLE_REGS_DUALPORT(0),\n    .CATCH_MISALIGN(0),\n    .CATCH_ILLINSN(0),\n    .TWO_CYCLE_ALU(1),\n    .TWO_CYCLE_COMPARE(1),\n    .LATCHED_MEM_RDATA(1)\n) cpu (\n\t.clk         (clk),\n\t.resetn      (!reset),\n\t.mem_valid   (mem_valid  ),\n\t.mem_ready   (mem_ready  ),\n\t.mem_addr    (mem_addr   ),\n\t.mem_wdata   (mem_wdata  ),\n\t.mem_wstrb   (mem_wstrb  ),\n\t.mem_rdata   (mem_rdata  )\n);\n\nreg [31:0] memory [0:511];\n\nwire mem_valid;\nreg mem_ready;\nwire [31:0] mem_addr;\nwire [31:0] mem_wdata;\nwire [3:0] mem_wstrb;\nreg  [31:0] mem_rdata;\n\nreg mmio_out_strobe;\nreg [31:0] mmio_out_data;\n\ninitial begin\n    if (mem_file) $readmemh(mem_file, memory);\nend\n\nwire mem_addr_io = mem_addr[31];\n\nalways @(posedge clk) begin\n    mem_ready <= 0;\n    mmio_out_strobe <= 0;\n    if (mem_valid && !mem_ready) begin\n        mem_ready <= 1;\n        if (mem_addr_io) begin\n\t\t    mem_rdata <= mmio_in;\n\t\t    mmio_out_strobe <= |mem_wstrb;\n\t    \tif (mem_wstrb[0]) mmio_out_data[ 7: 0] <= mem_wdata[ 7: 0];\n    \t    if (mem_wstrb[1]) mmio_out_data[15: 8] <= mem_wdata[15: 8];\n\t        if (mem_wstrb[2]) mmio_out_data[23:16] <= mem_wdata[23:16];\n\t\t    if (mem_wstrb[3]) mmio_out_data[31:24] <= mem_wdata[31:24];\n\t\tend\n\t\telse begin\n            mem_rdata <= memory[mem_addr >> 2];\n\t    \tif (mem_wstrb[0]) memory[mem_addr >> 2][ 7: 0] <= mem_wdata[ 7: 0];\n    \t    if (mem_wstrb[1]) memory[mem_addr >> 2][15: 8] <= mem_wdata[15: 8];\n\t        if (mem_wstrb[2]) memory[mem_addr >> 2][23:16] <= mem_wdata[23:16];\n\t\t    if (mem_wstrb[3]) memory[mem_addr >> 2][31:24] <= mem_wdata[31:24];\n\t\tend\n\tend\nend\n",
            "params": [
              {
                "name": "mem_file"
              }
        ...
        {
          "id": "c3764c98-6a1d-42e5-bb46-aee0b544c810",
          "type": "basic.code",
          "data": {
            "code": "assign o = {y, x};",
            "params": [],
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "98f3f157-c1ca-4536-959f-68984033cef7",
            "port": "clk"
          }
        },
        {
          "source": {
            "block": "ef99ec8d-f6ba-455b-baf2-b11c9e8aa460",
            "port": "o"
          },
          "target": {
            "block": "beb65ea7-53bf-44ad-b789-a9600601624a",
        ...
        },
        {
          ...
          "target": {
            "block": "c3764c98-6a1d-42e5-bb46-aee0b544c810",
            "port": "y"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "d4c65774-b86d-4d18-8252-0572909f0552",
            "port": "memory-out"
          },
          "target": {
            "block": "98f3f157-c1ca-4536-959f-68984033cef7",
        ...
        {
          "source": {
            "block": "7536e7c4-d9ce-4e4a-8a1c-ed83be992df9",
            "port": "constant-out"
          },
          "target": {
            "block": "c1de90a8-2bde-4a70-a1af-6fa7d5106d52",
